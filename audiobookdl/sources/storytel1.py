...
class StorytelSource(Source):
 ...
 #           f"https://www.storytel.com/api/login.action?m=1&token=guestpl&userid=-1&version=24.37"
 #           f"&terminal=android&locale=pl&deviceId={generated_device_id}&kidsMode=false",
